        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">Add New Category</h2>
                    ...
                    <form action="{{ route('category.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name')" required autofocus placeholder="e.g. Elektronik" />
